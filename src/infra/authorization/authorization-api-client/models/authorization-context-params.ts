...
export function AuthorizationContextParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorizationContextParams {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function AuthorizationContextParamsToJSONTyped(value?: AuthorizationContextParams | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
